...
from insurrector.gui import ABOUT, TITLE
from insurrector.gui.colors import log_colors
from insurrector.gui.multiselect import CheckableComboBox
from insurrector.gui.signals import LogSignal
from insurrector.gui.worker import Worker
...
class Window(QMainWindow, logging.Handler):
    ...
    def home(self):
        ...
        self.parser_combo.addItems(
            supported_parsers.keys(), next(iter(supported_parsers.keys()))
        )
    ...
    def start_worker(self):
        ...
        worker = Worker(
            ...
            self.input_dir,
            self.output_dir,
            self.parser_combo.get_selected(),
            False,
        )
